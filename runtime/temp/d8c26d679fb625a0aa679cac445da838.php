									...
									<div class="card-body cards">
										<form id="form" class="form-horizontal" onsubmit="return false" enctype="multipart/form-data"  target="addfile">
											<div class="form-group row text-center">
												<input type="hidden" name="id" value="<?php echo htmlentities(app('session')->get('uid')); ?>">
												<label class="col-md-2 col-form-label text-center">用户名</label>
												<div class="col-md-4">
													<input id="username" type="text" class="form-control" disabled="disabled" placeholder="user name" name="name" value="<?php echo htmlentities(app('session')->get('admin_name')); ?>">
												</div>
											</div>
											<div class="form-group row text-center">
											...
											<div class="form-group row text-center">
												...
												<label class="col-md-2 col-form-label text-center">确认密码
												</label>
												<div class="col-md-6">
...
<block name="js">
	<script type="text/javascript">
		$("#form").submit(function(){
			...
			$.ajax({
				type:'post',
				url:"<?php echo url('/admin/user/update'); ?>",
				data:formData,
				dataType:'json',
